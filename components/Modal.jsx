...
function Modal() {
  const trailerModalCurrentMovie = useTrailerModalStore(
    (state) => state.trailerModalCurrentMovie
  );
  ...
  return (
    ...
    >
      <motion.div className="w-full sm:w-4/5 md:w-2/3 h-full  relative  rounded-lg overflow-hidden z-[1000] ">
        ...
        <div className=" bg-neutral-900 text-white p-3 sm:p-5 md:p-8 flex flex-col gap-y-8 overflow-y-scroll h-44 lg:h-72">
